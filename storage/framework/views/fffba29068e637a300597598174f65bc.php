...
<?php $__env->startSection('title', 'Layanan Profesional - YoungDevelop'); ?>

<?php $__env->startSection('description', 'Jelajahi layanan pengembangan web profesional YoungDevelop: website bisnis, startup, e-commerce, desain UI/UX, dan asistensi proyek digital. Wujudkan ide Anda bersama kami.'); ?>
<?php $__env->startSection('keywords', 'jasa pengembangan website, web developer bandung, website umkm, website startup, desain ui ux, jasa joki skripsi, aplikasi web kustom, youngdevelop layanan'); ?>
...
<section class="max-w-7xl mx-auto px-4 py-16 md:py-20 overflow-hidden">
    ...
    <div class="mb-16 md:mb-24">
        ...
        <div class="grid md:grid-cols-3 gap-10">
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg border border-emerald-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1" data-aos="fade-up" data-aos-delay="<?php echo e(100 * ($index + 1)); ?>" data-aos-easing="ease-out-back">
                <div class="text-emerald-600 mb-6 text-5xl flex justify-center">
                    <?php echo $service['icon']; ?>

                </div>
                <h3 class="text-2xl font-bold text-emerald-700 mb-3"><?php echo e($service['title']); ?></h3>
                <p class="text-gray-600 mb-4 leading-relaxed"><?php echo e($service['desc']); ?></p>
                <ul class="list-disc list-inside text-sm text-gray-500 space-y-2 pl-4"> 
                    <?php $__currentLoopData = $service['points']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="mb-16 md:mb-24">
        ...
        <div class="grid md:grid-cols-2 gap-10">
            <?php $__currentLoopData = $caseStudies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $case): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white p-8 rounded-xl shadow-lg border border-emerald-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1" data-aos="fade-right" data-aos-delay="<?php echo e(100 * ($index + 1)); ?>">
                <img src="<?php echo e(asset('images/' . $case['image'])); ?>" alt="<?php echo e($case['title']); ?>" class="rounded-lg mb-6 w-full h-64 object-cover shadow-md border border-gray-200">
                <h3 class="text-2xl font-bold text-emerald-700 mb-3"><?php echo e($case['title']); ?></h3>
                <p class="text-gray-700 mb-2 leading-relaxed">
                    <strong class="text-emerald-600">Tantangan:</strong> <?php echo e($case['challenge']); ?>

                </p>
                <p class="text-gray-700 mb-2 leading-relaxed">
                    <strong class="text-emerald-600">Solusi:</strong> <?php echo e($case['solution']); ?>

                </p>
                <p class="text-gray-700 leading-relaxed">
                    <strong class="text-emerald-600">Hasil:</strong> <?php echo e($case['result']); ?>
        ...
        <div class="text-center mt-16" data-aos="fade-up" data-aos-delay="300">
            <a href="<?php echo e(route('portofolio')); ?>" class="inline-block bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-4 px-8 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
    ...
    <div class="bg-gradient-to-br from-emerald-600 to-emerald-800 text-white rounded-xl p-10 md:p-16 text-center shadow-2xl" data-aos="zoom-in" data-aos-duration="1000">
        ...
        <a href="<?php echo e(route('kontak')); ?>" class="inline-block bg-white text-emerald-700 px-8 py-4 rounded-full font-bold shadow-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105" data-aos="zoom-in" data-aos-delay="200" data-aos-duration="800">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\AADL\Program\YoungDevelop\resources\views/services.blade.php ENDPATH**/ ?>