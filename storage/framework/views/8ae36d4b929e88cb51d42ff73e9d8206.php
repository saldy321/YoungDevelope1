...
<?php $__env->startSection('title', 'Tentang Kami - YoungDevelop'); ?>
                    ...
                    <?php $__currentLoopData = $team; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div
                            ...
                            <div class="relative z-10">
                                <img src="<?php echo e(asset('images/team/' . $member['photo'])); ?>" alt="<?php echo e($member['nama']); ?>"
                                ...
                                <h3
                                    ...
                                    <?php echo e($member['nama']); ?></h3>
                                <p class="text-emerald-600 text-base font-semibold mb-3"><?php echo e($member['position']); ?></p>
                                <p class="text-gray-700 text-sm italic leading-relaxed"><?php echo e($member['bio']); ?></p>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\AADL\Program\YoungDevelop\resources\views/about.blade.php ENDPATH**/ ?>