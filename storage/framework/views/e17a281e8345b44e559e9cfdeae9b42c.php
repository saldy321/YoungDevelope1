...
<?php $__env->startSection('title', 'Portofolio Proyek - YoungDevelop'); ?>

<?php $__env->startSection('description', 'Jelajahi portofolio proyek digital YoungDevelop: website bisnis, e-commerce, aplikasi kustom, dan solusi inovatif lainnya untuk berbagai industri. Temukan inspirasi untuk proyek Anda.'); ?>
<?php $__env->startSection('keywords', 'portofolio web developer, contoh website, website bisnis, website startup, aplikasi kustom, desain ui ux, studi kasus, youngdevelop project'); ?>
...
<section class="max-w-7xl mx-auto px-4 py-16 md:py-20 overflow-hidden">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10" id="portfolio-grid">
        ...
        <a href="<?php echo e($project['live_url'] ?? '#'); ?>" target="_blank" rel="noopener noreferrer" 
           ...
           data-category="<?php echo e($project['category']); ?>" data-aos="fade-up" data-aos-delay="<?php echo e(100 * ($index % 3)); ?>">
            
            <img src="<?php echo e(asset('images/portofolio/' . $project['image'])); ?>" alt="<?php echo e($project['title']); ?>" class="w-full h-56 object-cover object-top border-b border-gray-200">
            <div class="p-6">
                <h3 class="text-xl font-bold text-emerald-700 mb-2"><?php echo e($project['title']); ?></h3>
                <p class="text-sm text-emerald-500 font-medium mb-3">Kategori: <?php echo e($project['category'] ?? 'Umum'); ?></p>
                <p class="text-gray-600 leading-relaxed mb-4"><?php echo e($project['short_description']); ?></p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\AADL\Program\YoungDevelop\resources\views/portofolio.blade.php ENDPATH**/ ?>