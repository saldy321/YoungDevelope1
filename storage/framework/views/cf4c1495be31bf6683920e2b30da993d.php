...
<head>
    ...
    <meta name="description" content="<?php echo $__env->yieldContent('description', 'YoungDevelop menyediakan solusi pengembangan website profesional dan terjangkau untuk UMKM, startup, dan proyek mahasiswa di Bandung.'); ?>">
    <meta name="keywords" content="<?php echo $__env->yieldContent('keywords', 'pengembangan website, jasa website, web design, startup website, umkm website, joki website, mahasiswa, bandung, web developer, youngdevelop'); ?>">
    <meta name="author" content="YoungDevelop">

    
    <meta property="og:title" content="<?php echo $__env->yieldContent('title', 'YoungDevelop - Solusi Pengembangan Website Profesional'); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('description', 'YoungDevelop menyediakan solusi pengembangan website profesional dan terjangkau untuk UMKM, startup, dan proyek mahasiswa di Bandung.'); ?>">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo e(url()->current()); ?>">
    <meta property="og:image" content="<?php echo $__env->yieldContent('og_image', asset('images/LogoYD_Light-noBg.png')); ?>">

    <title><?php echo $__env->yieldContent('title', 'YoungDevelop - Solusi Pengembangan Website Profesional'); ?></title>

    
    <link rel="icon" type="image/png" href="<?php echo e(asset('images/LogoYD_Dark-noBg.png')); ?>">
...
<body class="bg-gradient-to-br from-white via-emerald-50 to-white text-gray-800 font-sans overflow-x-hidden">
    ...
    <header class="bg-white shadow-md sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('beranda')); ?>" class="flex items-center gap-3"> 
                    <img src="<?php echo e(asset('images/LogoYD_Light-noBg.png')); ?>" alt="YoungDevelop Logo"
            ...
            <nav class="hidden md:flex gap-6 text-gray-700 text-sm md:text-base">
                <a href="<?php echo e(route('tentang')); ?>"
                    class="<?php if(request()->routeIs('tentang')): ?> text-emerald-600 font-semibold <?php endif; ?> hover:text-emerald-500 transition-colors duration-200 relative group">
                    Tentang Kami
                    <span
                        class="absolute left-0 -bottom-1 w-0 h-0.5 bg-emerald-500 transition-all group-hover:w-full <?php if(request()->routeIs('tentang')): ?> w-full <?php endif; ?>"></span>
                </a>
                <a href="<?php echo e(route('layanan')); ?>"
                    class="<?php if(request()->routeIs('layanan')): ?> text-emerald-600 font-semibold <?php endif; ?> hover:text-emerald-500 transition-colors duration-200 relative group">
                    Layanan
                    <span
                        class="absolute left-0 -bottom-1 w-0 h-0.5 bg-emerald-500 transition-all group-hover:w-full <?php if(request()->routeIs('layanan')): ?> w-full <?php endif; ?>"></span>
                </a>
                <a href="<?php echo e(route('portofolio')); ?>"
                    class="<?php if(request()->routeIs('portofolio')): ?> text-emerald-600 font-semibold <?php endif; ?> hover:text-emerald-500 transition-colors duration-200 relative group">
                    Portofolio
                    <span
                        class="absolute left-0 -bottom-1 w-0 h-0.5 bg-emerald-500 transition-all group-hover:w-full <?php if(request()->routeIs('portofolio')): ?> w-full <?php endif; ?>"></span>
                </a>
                <a href="<?php echo e(route('kontak')); ?>"
                    class="<?php if(request()->routeIs('kontak')): ?> text-emerald-600 font-semibold <?php endif; ?> hover:text-emerald-500 transition-colors duration-200 relative group">
                    Kontak
                    <span
                        class="absolute left-0 -bottom-1 w-0 h-0.5 bg-emerald-500 transition-all group-hover:w-full <?php if(request()->routeIs('kontak')): ?> w-full <?php endif; ?>"></span>
                </a>
            </nav>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white shadow-inner pb-4">
            <nav class="flex flex-col items-center gap-4 text-gray-700 text-base">
                <a href="<?php echo e(route('tentang')); ?>"
                    class="<?php if(request()->routeIs('tentang')): ?> text-emerald-600 font-semibold <?php endif; ?> hover:text-emerald-500 transition-colors duration-200 w-full text-center py-2">
                    Tentang Kami
                </a>
                <a href="<?php echo e(route('layanan')); ?>"
                    class="<?php if(request()->routeIs('layanan')): ?> text-emerald-600 font-semibold <?php endif; ?> hover:text-emerald-500 transition-colors duration-200 w-full text-center py-2">
                    Layanan
                </a>
                <a href="<?php echo e(route('portofolio')); ?>"
                    class="<?php if(request()->routeIs('portofolio')): ?> text-emerald-600 font-semibold <?php endif; ?> hover:text-emerald-500 transition-colors duration-200 w-full text-center py-2">
                    Portofolio
                </a>
                <a href="<?php echo e(route('kontak')); ?>"
                    class="<?php if(request()->routeIs('kontak')): ?> text-emerald-600 font-semibold <?php endif; ?> hover:text-emerald-500 transition-colors duration-200 w-full text-center py-2">
                    Kontak
                </a>
            </nav>
        </div>
    ...
    <footer class="bg-gradient-to-t from-emerald-900 via-emerald-800 to-emerald-700 text-white py-10 mt-20">
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-white/80 text-sm">
                    <li><a href="<?php echo e(route('beranda')); ?>"
        ...
        <div class="mt-10 text-center text-white/50 text-sm border-t border-white/20 pt-4">
            &copy; <?php echo e(date('Y')); ?> YoungDevelop. All rights reserved.
...
<?php /**PATH D:\AADL\Program\YoungDevelop\resources\views/layouts/app.blade.php ENDPATH**/ ?>